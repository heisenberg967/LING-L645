...
def generate_bot_json():
    bot_json = {
        "name":"quizbowl_bot","version":"DRAFT","description":None,"identifier":"PTVTD8YVN2","dataPrivacy":{"childDirected":False},"idleSessionTTLInSeconds":300
    }
...
for ele in quizbowl_train_data:
    if nlu_generator.is_intent_valid(ele):
        ...
        lex_agent_params["intents"].append(ele.replace(" ", "_"))
